...
public final class ConnectionDialog extends JDialog
{
    ...
    private void initCenterPanelComponents()
    {
        ...
        this.passiveFtpOption = new JCheckBox(VFSResources.getMessage(
        "VFSJFileChooser.passiveFtpOptionText"));
    ...
    private void initListeners()
    {
        ...
        this.passiveFtpOption.addItemListener(new ItemListener()
            {
                public void itemStateChanged(ItemEvent item) {
                    JCheckBox option = (JCheckBox) item.getItem();
                    FtpFileSystemConfigBuilder.getInstance().setPassiveMode(ftpFileOptions, option.isSelected());
                }
            });
                    ...
                    currentWorker = new Thread()
                            {
                                ...
                                public void run()
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        {
                                            fo = VFSUtils.resolveFileObject(uri, ftpFileOptions);
                                        }
                                        else
                                        {
                                    ...
                                    if (bookmarksDialog != null)
                                    {
                                        ...
                                        bookmarksDialog.getBookmarks().add(
                                            new TitledURLEntry(bTitle, bURL));
